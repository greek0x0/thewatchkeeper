...
from watchkeeper.log import Log
from watchkeeper.parsed_feed_item import ParsedFeedItem
from watchkeeper.parsed_feed_site import ParsedFeedSite
from watchkeeper.settings import Settings
    ...
    def fetch_site(
        ...
        try:
            feed_response = requests.get(
                url,
                headers={
                    "User-Agent": "watchkeeper/0.1 (https://github.com/greek0x0/thewatchkeeper)",
                },
                timeout=15,
            )
